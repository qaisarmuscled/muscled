...
function quickView() {
  ...
  $(".quick-view").click(function () {
    ...
    jQuery.getJSON('/products/' + product_handle + '.js', function (product) {
      ...
      var first_var_id = product.variants[0].id;
      ...
      $('.add-to-cart-varId').val(first_var_id);
      ...
      $(images).each(function (i, image) {
        ...
        if (i == imageCount - 1) {
          ...
          var image_embed = '<div><img class="lazyload" src="' + image + '"></div>';
          ...
          image_embed = '<div><img class="lazyload" src="' + image + '"></div>';
